...
AUTHORS = {
    ...
    "neville": dict(display='Neville Goddard', signature='- Neville Goddard',
    ...
    "murphy": dict(display='Joseph Murphy', signature='- Joseph Murphy',
    ...
    "hay": dict(display='Louise Hay', signature='- Louise Hay',
    ...
    "hill": dict(display='Napoleon Hill', signature='- Napoleon Hill',
    ...
    "fox": dict(display='Emmet Fox', signature='- Emmet Fox',
    ...
    "jung": dict(display='Carl Jung', signature='- Carl Jung',
        ...
        premise_hint="a verified Jung insight (no scripture), e.g. 'what is not made conscious happens outside, as fate'",
